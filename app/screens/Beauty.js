...
import {
    ...
    Alert, Image, TouchableOpacity, View, ScrollView, FlatList, AsyncStorage, BackHandler
} from 'react-native';
...
class Screen extends Component {
    ...
    async componentWillMount() {
        try {
            ...
            console.log('error catched in Beauty tab');
        }
    ...
    async handleChange(tab) {
        try {
            ...
            console.log('fashion.js async error')
        }
        if (tab === 0)
